...
\title{Predicción de ausentismo a citas médicas con aprendizaje de máquinas: \\
...
\begin{itemize}
  \item \textbf{Asignación endógena de SMS:} \texttt{sms\_received} refleja decisiones operativas
  ...
  \item \textbf{Soporte común imperfecto (overlap) y pesos extremos:} las distribuciones de
  ...
  \item \textbf{Calibración de probabilidades:} aunque la calidad de ranking es buena
  ...
  \item \textbf{Validez externa y dataset shift:} los datos provienen de una sola ciudad
...
\begin{itemize}
  \item \textbf{Calibración post-estimación:} aplicar métodos isotónicos o de Platt en un conjunto
  ...
  \item \textbf{Evaluación temporal y robustez a drift:} reemplazar el split aleatorio por un split
  ...
  \item \textbf{De scores a decisiones:} combinar el score $\widehat p_0(X)$ con información sobre
  ...
  \item \textbf{Modelos adicionales y comparación:} explorar variantes gradiente (GBDT, XGBoost/LightGBM)
